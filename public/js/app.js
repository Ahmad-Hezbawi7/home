...
$jscomp.polyfill("Array.from", function (a) {
  return a ? a : function (a, c, d) {
    ...
    var b = [],
        e = a[Symbol.iterator];
    if ("function" == typeof e) for (a = e.call(a); !(e = a.next()).done;) {
      b.push(c.call(d, e.value));
    } else for (var e = a.length, g = 0; g < e; g++) {
      b.push(c.call(d, a[g]));
    }
    return b;
  };
